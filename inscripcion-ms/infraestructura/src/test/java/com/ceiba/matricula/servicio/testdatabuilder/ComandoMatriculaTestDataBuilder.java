...
public class ComandoMatriculaTestDataBuilder {
    ...
    public ComandoMatriculaTestDataBuilder(Programa programa, UsuarioMatricula usuarioMatricula) {
        this.id = 1234L;
    ...
    public ComandoMatriculaTestDataBuilder conId(Long id) {
        this.id = id;
        return this;
    }

    public ComandoMatriculaTestDataBuilder conValor(Double valor) {
        this.valor = valor;
        return this;
    }

    public ComandoMatriculaTestDataBuilder conRecargo(boolean recargo) {
        this.recargo = recargo;
        return this;
    }

    public ComandoMatriculaTestDataBuilder conEstadoDePago(EstadoDePago estadoDePago) {
        this.estadoDePago = estadoDePago;
        return this;
    }

    public ComandoMatriculaTestDataBuilder conFechaDeCreacion(LocalDateTime fechaCreacion) {
        this.fechaCreacion = fechaCreacion;
        return this;
    }

    public ComandoMatriculaTestDataBuilder conFechaLimitePagoSinRecargo(LocalDateTime fechaLimitePagoSinRecargo) {
        this.fechaLimitePagoSinRecargo = fechaLimitePagoSinRecargo;
        return this;
    }

    public ComandoMatriculaTestDataBuilder conFechaMaximaPago(LocalDateTime fechaMaximaPago) {
        this.fechaMaximaPago = fechaMaximaPago;
        return this;
    }

    public ComandoMatriculaTestDataBuilder conPrograma(Programa programa) {
        this.programa = programa;
        return this;
    }

    public ComandoMatriculaTestDataBuilder conUsuarioMatricula(UsuarioMatricula usuarioMatricula) {
        this.usuarioMatricula = usuarioMatricula;
        return this;
    }

    public ComandoMatricula build() {
        return new ComandoMatricula(id,valor, recargo, estadoDePago,fechaCreacion,fechaLimitePagoSinRecargo, fechaMaximaPago, programa, usuarioMatricula, null);
    }
