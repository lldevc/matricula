...
public class ManejadorActualizarMatricula implements ManejadorComando<ComandoMatricula> {
    ...
    public ManejadorActualizarMatricula(FabricaMatricula fabricaMatricula, ServicioActualizarMatricula servicioActualizarMatricula, ServicioActualizarEstadoMatricula servicioActualizarEstadoMatricula, ServicioPagarMatricula servicioPagarMatricula, DaoMatricula daoMatricula) {
